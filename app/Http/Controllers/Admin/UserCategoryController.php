...
class UserCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.userCategories.index', compact('userCategories'));
    }
    ...
    public function edit(UserCategory $userCategory)
    {
        ...
        return view('admin.userCategories.edit', compact('userCategory'));
    }
    ...
    public function show(UserCategory $userCategory)
    {
        ...
        return view('admin.userCategories.show', compact('userCategory'));
    }
