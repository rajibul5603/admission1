...
class LevelWiseClassController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.levelWiseClasses.index', compact('levelWiseClasses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.levelWiseClasses.create', compact('academic_levels'));
    }
    ...
    public function store(StoreLevelWiseClassRequest $request)
    {
        ...
        return redirect()->route('frontend.level-wise-classes.index');
    }
    ...
    public function edit(LevelWiseClass $levelWiseClass)
    {
        ...
        return view('frontend.levelWiseClasses.edit', compact('academic_levels', 'levelWiseClass'));
    }
    ...
    public function show(LevelWiseClass $levelWiseClass)
    {
        ...
        return view('frontend.levelWiseClasses.show', compact('levelWiseClass'));
    }
