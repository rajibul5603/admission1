...
class DisbursementController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.disbursements.index', compact('disbursements'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.disbursements.create');
    }
    ...
    public function store(StoreDisbursementRequest $request)
    {
        ...
        return redirect()->route('frontend.disbursements.index');
    }
    ...
    public function edit(Disbursement $disbursement)
    {
        ...
        return view('frontend.disbursements.edit', compact('disbursement'));
    }
    ...
    public function show(Disbursement $disbursement)
    {
        ...
        return view('frontend.disbursements.show', compact('disbursement'));
    }
