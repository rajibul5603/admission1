    ...
    @can('education_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'Education', 'route' => 'admin.education.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="row">
                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Education">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.education.fields.degree') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($education as $key => $education)
                                    <tr data-entry-id="{{ $education->id }}">
                                        ...
                                        <td>
                                            {{ App\Models\Education::DEGREE_SELECT[$education->degree] ?? '' }}
                                        </td>
                                        <td>
                                            @can('education_show')
