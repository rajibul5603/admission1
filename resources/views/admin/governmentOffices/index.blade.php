...
<div class="content">
    @can('government_office_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.government-offices.create') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-GovernmentOffice">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('government_office_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.government-offices.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.government-offices.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'ministry_name_ministry_name', name: 'ministry_name.ministry_name' },
{ data: 'ministry_name.division_name', name: 'ministry_name.division_name' },
{ data: 'govt_ogranization_name', name: 'govt_ogranization_name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-GovernmentOffice').DataTable(dtOverrideGlobals);
