        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-FamilyInfo">
                        <thead>
                            <tr>
                                <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.family-infos.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'application_number_application_no', name: 'application_number.application_no' },
{ data: 'familystatus_status_name', name: 'familystatus.status_name' },
{ data: 'guardian_occupation_occupation_name', name: 'guardian_occupation.occupation_name' },
{ data: 'guardian_education', name: 'guardian_education' },
{ data: 'guardian_land', name: 'guardian_land' },
{ data: 'guardian_annual_income', name: 'guardian_annual_income' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-FamilyInfo').DataTable(dtOverrideGlobals);
