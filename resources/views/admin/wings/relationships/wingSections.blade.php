            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-wingSections">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.section.fields.wing') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.section.fields.location') }}
                                    </th>
                                    <th>
...
@endcan
  ...
  let table = $('.datatable-wingSections:not(.ajaxTable)').DataTable({ buttons: dtButtons })
