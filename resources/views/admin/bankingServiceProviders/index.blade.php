...
<div class="content">
    @can('banking_service_provider_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.banking-service-providers.create') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BankingServiceProvider">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('banking_service_provider_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.banking-service-providers.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.banking-service-providers.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'bank_type_banking_type', name: 'bank_type.banking_type' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-BankingServiceProvider').DataTable(dtOverrideGlobals);
