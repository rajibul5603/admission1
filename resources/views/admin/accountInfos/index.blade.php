        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AccountInfo">
                        <thead>
                            <tr>
                                <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.account-infos.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'app_number_name', name: 'app_number.name' },
{ data: 'banking_type_banking_type', name: 'banking_type.banking_type' },
{ data: 'bank_name_name', name: 'bank_name.name' },
{ data: 'bank_branch_branch_name', name: 'bank_branch.branch_name' },
{ data: 'routing_no', name: 'routing_no' },
{ data: 'bank_account_owner', name: 'bank_account_owner' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AccountInfo').DataTable(dtOverrideGlobals);
