            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-sectionPosts">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.post.fields.wing') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.post.fields.section') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.post.fields.post_name') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.post.fields.no_of_post') }}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach($posts as $key => $post)
                                    <tr data-entry-id="{{ $post->id }}">
                                        ...
                                        <td>
                                            @foreach($post->sections as $key => $item)
                                                <span class="label label-info label-many">{{ $item->section_name }}</span>
                                            @endforeach
                                        </td>
                                        <td>
                                            {{ $post->post_name ?? '' }}
...
@endcan
  ...
  let table = $('.datatable-sectionPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
