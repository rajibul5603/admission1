...
<div class="content">
    @can('ministry_division_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.ministry-divisions.create') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-MinistryDivision">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('ministry_division_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.ministry-divisions.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.ministry-divisions.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-MinistryDivision').DataTable(dtOverrideGlobals);
