                            ...
                            <fieldset class="border">
                                ...
                                <div class=" form-row">
                                    ...
                                    <div class="col-md-6 {{ $errors->has('dob') ? ' has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="dob" id="datepicker" value="{{ old('dob') }}" min='1899-01-01' max='2000-13-13' readonly="readonly" required>
                                        @if($errors->has('dob'))
                                    ...
                                    <div class="col-md-4 pull-right">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-success btn-block">
                                            <span style="font-size:  25px !important;"> &#10003; {{ trans('global.register') }}</span> </button>

                                    </div>

    					<div class="col-md-4 pull-left">
 
                                     <a href="{{url('/login')}}"  class="btn btn-back">  &#10094; {{ trans('global.back') }}</a>
