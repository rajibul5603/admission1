        ...
        <div class="col-md-12">
            @can('disbursement_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.disbursements.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $disbursement->id }}">
                                        ...
                                        <td>
                                            @can('disbursement_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.disbursements.show', $disbursement->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('disbursement_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.disbursements.edit', $disbursement->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('disbursement_delete')
                                                <form action="{{ route('frontend.disbursements.destroy', $disbursement->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('disbursement_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.disbursements.massDestroy') }}",
