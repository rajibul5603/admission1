        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.disbursement.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.disbursements.update", [$disbursement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="app_number">{{ trans('cruds.disbursement.fields.app_number') }}</label>
                            <input class="form-control" type="text" name="app_number" id="app_number" value="{{ old('app_number', $disbursement->app_number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="stu_name" id="stu_name" value="{{ old('stu_name', $disbursement->stu_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="brid" id="brid" value="{{ old('brid', $disbursement->brid) }}" required>
                            @if($errors->has('brid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('brid') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="acc_no" id="acc_no" value="{{ old('acc_no', $disbursement->acc_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="acc_name" id="acc_name" value="{{ old('acc_name', $disbursement->acc_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $disbursement->bank_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bank_branch" id="bank_branch" value="{{ old('bank_branch', $disbursement->bank_branch) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="routing_no" id="routing_no" value="{{ old('routing_no', $disbursement->routing_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="student_division" id="student_division" value="{{ old('student_division', $disbursement->student_division) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="student_district" id="student_district" value="{{ old('student_district', $disbursement->student_district) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="student_upazila" id="student_upazila" value="{{ old('student_upazila', $disbursement->student_upazila) }}" required>
