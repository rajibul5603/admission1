    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.districts.update", [$district->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="division_name_id" id="division_name_id" required>
                                @foreach($division_names as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('division_name_id') ? old('division_name_id') : $district->division_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="district_name" id="district_name" value="{{ old('district_name', $district->district_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="district_name_en" id="district_name_en" value="{{ old('district_name_en', $district->district_name_en) }}">
