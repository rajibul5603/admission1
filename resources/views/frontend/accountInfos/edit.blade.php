        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.accountInfo.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.account-infos.update", [$accountInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="user">{{ trans('cruds.accountInfo.fields.user') }}</label>
                            <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $accountInfo->user) }}" required>
                            @if($errors->has('user'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="app_number_id" id="app_number_id" required>
                                @foreach($app_numbers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('app_number_id') ? old('app_number_id') : $accountInfo->app_number->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="student_name" id="student_name" value="{{ old('student_name', $accountInfo->student_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="banking_type_id" id="banking_type_id" required>
                                @foreach($banking_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('banking_type_id') ? old('banking_type_id') : $accountInfo->banking_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bank_name_id" id="bank_name_id" required>
                                @foreach($bank_names as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bank_name_id') ? old('bank_name_id') : $accountInfo->bank_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="district_id" id="district_id">
                                @foreach($districts as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('district_id') ? old('district_id') : $accountInfo->district->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bank_branch_id" id="bank_branch_id">
                                @foreach($bank_branches as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bank_branch_id') ? old('bank_branch_id') : $accountInfo->bank_branch->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="routing_no" id="routing_no" value="{{ old('routing_no', $accountInfo->routing_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="bank_account_owner" id="bank_account_owner" required>
                                ...
                                @foreach(App\Models\AccountInfo::BANK_ACCOUNT_OWNER_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('bank_account_owner', $accountInfo->bank_account_owner) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="acc_name" id="acc_name" value="{{ old('acc_name', $accountInfo->acc_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="acc_no" id="acc_no" value="{{ old('acc_no', $accountInfo->acc_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="account_type" id="account_type">
                                ...
                                @foreach(App\Models\AccountInfo::ACCOUNT_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('account_type', $accountInfo->account_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="branch_code_id" id="branch_code_id">
                                @foreach($branch_codes as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('branch_code_id') ? old('branch_code_id') : $accountInfo->branch_code->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_holder_nid" id="account_holder_nid" value="{{ old('account_holder_nid', $accountInfo->account_holder_nid) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eiin" id="eiin" value="{{ old('eiin', $accountInfo->eiin) }}">
                            @if($errors->has('eiin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('eiin') }}
                                </div>
