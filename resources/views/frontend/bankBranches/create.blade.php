        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.bankBranch.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bank-branches.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="branch_code" id="branch_code" value="{{ old('branch_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="routing_number" id="routing_number" value="{{ old('routing_number', '') }}" step="1" required>
