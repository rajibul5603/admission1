        ...
        <div class="col-md-12">
            @can('general_info_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.general-infos.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-GeneralInfo">
                            <thead>
                                <tr>
                                    <th>
                            ...
                            <tbody>
                                @foreach($generalInfos as $key => $generalInfo)
                                    <tr data-entry-id="{{ $generalInfo->id }}">
                                        <td>
                                            {{ $generalInfo->id ?? '' }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @can('general_info_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.general-infos.show', $generalInfo->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('general_info_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.general-infos.edit', $generalInfo->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('general_info_delete')
                                                <form action="{{ route('frontend.general-infos.destroy', $generalInfo->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('general_info_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.general-infos.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-GeneralInfo:not(.ajaxTable)').DataTable({ buttons: dtButtons })
