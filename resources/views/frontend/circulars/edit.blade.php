    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.circulars.update", [$circular->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('sec_stipend_amount'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sec_stipend_amount') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('hsec_stipend_amount'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hsec_stipend_amount') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('hons_stipend_amount'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hons_stipend_amount') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('institution_head_deadline'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('institution_head_deadline') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <label class="required" for="circular_status">{{ trans('cruds.circular.fields.circular_status') }}</label>
                            </div>
                            @if($errors->has('circular_status'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('circular_status') }}
                                </div>
                            @endif
...
<script>
    ...
    url: '{{ route('frontend.circulars.storeMedia') }}',
    maxFilesize: 2, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
