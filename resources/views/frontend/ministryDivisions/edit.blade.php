        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.ministryDivision.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.ministry-divisions.update", [$ministryDivision->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="ministry_name">{{ trans('cruds.ministryDivision.fields.ministry_name') }}</label>
                            <input class="form-control" type="text" name="ministry_name" id="ministry_name" value="{{ old('ministry_name', $ministryDivision->ministry_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="division_name" id="division_name" value="{{ old('division_name', $ministryDivision->division_name) }}">
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="active" id="active" value="1" {{ $ministryDivision->active || old('active', 0) === 1 ? 'checked' : '' }} required>
