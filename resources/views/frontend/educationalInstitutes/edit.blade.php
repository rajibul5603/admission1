        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.educationalInstitute.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.educational-institutes.update", [$educationalInstitute->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="institution_eiin_no">{{ trans('cruds.educationalInstitute.fields.institution_eiin_no') }}</label>
                            <input class="form-control" type="text" name="institution_eiin_no" id="institution_eiin_no" value="{{ old('institution_eiin_no', $educationalInstitute->institution_eiin_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="institution_name" id="institution_name" value="{{ old('institution_name', $educationalInstitute->institution_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="institution_code" id="institution_code" value="{{ old('institution_code', $educationalInstitute->institution_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mpo_number" id="mpo_number" value="{{ old('mpo_number', $educationalInstitute->mpo_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="legal_status_id" id="legal_status_id">
                                @foreach($legal_statuses as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('legal_status_id') ? old('legal_status_id') : $educationalInstitute->legal_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="academic_levels[]" id="academic_levels" multiple>
                                @foreach($academic_levels as $id => $academic_level)
                                    <option value="{{ $id }}" {{ (in_array($id, old('academic_levels', [])) || $educationalInstitute->academic_levels->contains($id)) ? 'selected' : '' }}>{{ $academic_level }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="disciplines[]" id="disciplines" multiple>
                                @foreach($disciplines as $id => $discipline)
                                    <option value="{{ $id }}" {{ (in_array($id, old('disciplines', [])) || $educationalInstitute->disciplines->contains($id)) ? 'selected' : '' }}>{{ $discipline }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="institute_head" id="institute_head" value="{{ old('institute_head', $educationalInstitute->institute_head) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $educationalInstitute->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mobile_phone" id="mobile_phone" value="{{ old('mobile_phone', $educationalInstitute->mobile_phone) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="phone" id="phone" value="{{ old('phone', $educationalInstitute->phone) }}" step="1">
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="division_id" id="division_id" required>
                                @foreach($divisions as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('division_id') ? old('division_id') : $educationalInstitute->division->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="district_id" id="district_id">
                                @foreach($districts as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('district_id') ? old('district_id') : $educationalInstitute->district->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="upazila_id" id="upazila_id">
                                @foreach($upazilas as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('upazila_id') ? old('upazila_id') : $educationalInstitute->upazila->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="union_id" id="union_id">
                                @foreach($unions as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('union_id') ? old('union_id') : $educationalInstitute->union->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('union'))
                                <div class="invalid-feedback">
