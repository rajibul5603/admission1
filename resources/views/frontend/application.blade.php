                        ...
                        <fieldset class="border">
                            ...
                            <div class=" form-row">
                                ...
                                <div class="col-md-6 {{ $errors->has('mother_nid') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="mother_nid" id="mother_nid" value="{{ old('mother_nid', '') }}" step="1" oninvalid="this.setCustomValidity('Please Change NID')" oninput='setCustomValidity(mother_nid.value == father_nid.value)' minlength="10"  onkeypress="return (event.charCode >= 48 && event.charCode <= 57) ||  event.charCode == 46 || event.charCode == 0 " onKeyDown="if (this.value.length==10 && event.keyCode!=8) return false"  placeholder="১০ ডিজিটের জাতীয় পরিচয়পত্র নম্বর" >
                                ...
                                <div class="col-md-6 {{ $errors->has('village') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="village_id" id="village_id" value="{{ old('village_id', '') }}" required>
